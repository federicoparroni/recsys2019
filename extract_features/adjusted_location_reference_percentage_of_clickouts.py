...
class AdjustedLocationReferencePercentageOfClickouts(FeatureBase):

    """
    Same feature as LocationReferencePercentageOfClickouts, but the popularity
    is calculated in a slightly different way as in PersonalizedTopPop.

    user_id | session_id | item_id | adj_percentage_of_total_city_clk

    """

    def __init__(self, mode, cluster='no_cluster'):
        name = 'adjusted_location_reference_percentage_of_clickouts'
        super(AdjustedLocationReferencePercentageOfClickouts, self).__init__(
    ...
    def extract_feature(self):
        ...
        feature.adj_percentage_of_total_city_clk = feature.adj_percentage_of_total_city_clk.astype(float)
        final_feature_reduced = feature[['user_id','session_id','item_id','adj_percentage_of_total_city_clk']]
...
if __name__ == '__main__':
    ...
    c = AdjustedLocationReferencePercentageOfClickouts(mode, cluster)
