...
class AdjustedPlatformReferencePercentageOfClickouts(FeatureBase):

    """
    Same feature as PlatformReferencePercentageOfClickouts, but the popularity
    is calculated in a slightly different way as in PersonalizedTopPop.

    user_id | session_id | item_id | adj_percentage_of_total_plat_clk

    """

    def __init__(self, mode, cluster='no_cluster'):
        name = 'adjusted_platform_reference_percentage_of_clickouts'
        super(AdjustedPlatformReferencePercentageOfClickouts, self).__init__(
    ...
    def extract_feature(self):
        ...
        feature['adj_percentage_of_total_plat_clk'] = new_col
        feature.adj_percentage_of_total_plat_clk = feature.adj_percentage_of_total_plat_clk.astype(float)
        final_feature_reduced = feature[['user_id','session_id','item_id','adj_percentage_of_total_plat_clk']]
...
if __name__ == '__main__':
    ...
    c = AdjustedPlatformReferencePercentageOfClickouts(mode, cluster)
