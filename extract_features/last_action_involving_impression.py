...
class LastInteractionInvolvingImpression(FeatureBase):
    ...
    | user_id | session_id | item_id | last_action_type_with_impr
    last_action_involving_impression is a string
    """

    def __init__(self, mode, cluster='no_cluster'):
        name = 'last_action_involving_impression'
        columns_to_onehot = [('last_action_type_with_impr', 'single')]
    ...
    def extract_feature(self):
        ...
        final_df_ = final_df_.drop(['num_interactions_impr','step_from_last_interaction','timestamp_from_last_interaction'], axis=1)
        return final_df_
