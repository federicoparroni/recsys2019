...
class ScoresSoftmaxLoss(FeatureBase):
    ...
    def read_feature(self, one_hot=False, create_not_existing_features=True):
        ...
        df['normalized_softmax_loss'] = x_scaled
        df = df[['user_id', 'session_id', 'item_id', 'normalized_softmax_loss']]
