...
class ScoresRNN0(FeatureBase):
    ...
    def read_feature(self, one_hot=False, create_not_existing_features=True):
        ...
        df['normalized_rnn_0'] = x_scaled
        df = df[['user_id', 'session_id', 'item_id', 'normalized_rnn_0']]
